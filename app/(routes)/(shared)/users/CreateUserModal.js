...
export default function CreateUserModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleProfileImageUploaded = (filePath, url) => {
    setUserData(prev => ({ ...prev, profileImageUrl: filePath }));
  };
    ...
    try {
      const response = await fetch('/api/moderator/users', {
        ...
        body: JSON.stringify({
          ...
          profile_pic_url: userData.profileImageUrl,
        }),
      });
          ...
          {!success ? (
            <div className="space-y-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 text-sm">User Account</h3>
                    <p className="text-xs text-blue-700 mt-1">
                      Create a regular user account with basic permissions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 mb-6">
                The user account has been created and added to your organisation.
              </p>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-5 mb-6">
                ...
                <div className="space-y-3 text-left">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{createdUser.full_name}</p>
                  </div>
                  <div>
                    <p className="text-xs text-blue-600 mb-1">Email</p>
                    <p className="font-semibold text-gray-900">{createdUser.email}</p>
                  </div>
                  <div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-xs text-yellow-800 text-left">
                    Share these credentials securely with the user. The password cannot be retrieved later.
                  </p>
                </div>
              </div>
            </div>
